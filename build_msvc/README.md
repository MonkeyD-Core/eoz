...
Dependencies
---------------------
A number of [open source libraries](https://github.com/eozi/eozi/blob/master/doc/dependencies.md) are required in order to be able to build Bitcoin Core.
...
To build Bitcoin Core without Qt unload or disable the eozi-qt, libeozi_qt and test_eozi-qt projects.
