...
// eozi includes.
#include <..\src\script\eoziconsensus.h>
...
int main()
{
    std::cout << "eoziconsensus version: " << eoziconsensus_version() << std::endl;
    ...
    auto op0Result = eoziconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, eoziconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
