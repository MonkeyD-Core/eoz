...
"""Verify that starting eozi with -h works as expected."""

from test_framework.test_framework import EoziTestFramework
from test_framework.util import assert_equal

class HelpTest(EoziTestFramework):
    ...
    def run_test(self):
        self.log.info("Start eozi with -h for help text")
        ...
        self.log.info("Start eozi with -version for version information")
        ...
        self.log.info("Start eozid with -fakearg to make sure it does not start")
