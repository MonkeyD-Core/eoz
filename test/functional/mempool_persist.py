...
By default, eozid will dump mempool on shutdown and
...
class MempoolPersistTest(EoziTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent eozid from writing mempool.dat to disk. Verify that `savemempool` fails")
