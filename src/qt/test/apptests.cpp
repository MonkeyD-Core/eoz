...
//! Entry point for EoziApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &EoziApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for EoziGUI tests.
void AppTests::guiTests(EoziGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &EoziGUI::consoleShown, this, &AppTests::consoleTests);
