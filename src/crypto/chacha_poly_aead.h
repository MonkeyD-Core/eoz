...
#ifndef EOZI_CRYPTO_CHACHA_POLY_AEAD_H
#define EOZI_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@eozi.
 *
 ...
 *
 * The chacha20-poly1305@eozi combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@eozi cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@eozi are relatively fast in
...
#endif // EOZI_CRYPTO_CHACHA_POLY_AEAD_H
