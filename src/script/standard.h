...
#ifndef EOZI_SCRIPT_STANDARD_H
#define EOZI_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a eozi address
 */
...
/**
 * Generate a Eozi scriptPubKey for the given CTxDestination. Returns a P2PKH
