...
#ifndef EOZI_TEST_SCRIPTNUM10_H
#define EOZI_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Eozi Core 0.10.0, for cross-comparison.
 */
public:
