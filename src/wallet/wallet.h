...
#ifndef EOZI_WALLET_WALLET_H
#define EOZI_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! eozi from opening the wallet, thinking it was newly created, and
 ...
 * change.
 *
 * The Eozi Core wallet was originally a collection of unrelated private
...
public:
     ...
     * on this eozi node, and set to 0 for transactions that were created
