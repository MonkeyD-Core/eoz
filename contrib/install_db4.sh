...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the eozi repository."
  exit 1
fi
...
# See https://github.com/eozi/eozi/issues/16064
...
echo 'When compiling eozid, run `./configure` in the following way:'
echo
