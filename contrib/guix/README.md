# Bootstrappable Eozi Core Builds

This directory contains the files necessary to perform bootstrappable Eozi
Core builds.
...
- 24GB of free disk space on the partition that the Eozi Core git repository
  resides in
...
For a Eozi Core depends development environment, simply invoke
...
From the top of a clean Eozi Core repository:
...
To use dongcarl's substitute server for Eozi Core builds after having
