Contributing to Eozi Core
============================

The Eozi Core project operates an open contributor model where anyone is
...
Most communication about Eozi Core development happens on IRC, in the
...
The following applies to code changes to the Eozi Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Eozi
Network Protocol consensus changes.

Whether a pull request is merged into Eozi Core rests with the project merge
...
Patches that change Eozi consensus rules are considerably more involved than
...
Where a patch set proposes to change the Eozi consensus, it must have been
...
The project leader is the release manager for each Eozi Core release.
