...
This document provides guidelines for internationalization of the Eozi Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `eozi_en.ts` remains unchanged.
