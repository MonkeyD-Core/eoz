# RapidCheck property-based testing for Eozi Core

## Concept

Property-based testing is experimentally being added to Eozi Core with
...
If RapidCheck is installed, Eozi Core will automatically run the
...
3. Configure Eozi Core with RapidCheck.
...
4. Build Eozi Core with RapidCheck.
...
That's it! You are now running property-based tests in Eozi Core.
