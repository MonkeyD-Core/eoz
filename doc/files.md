...
eozi.conf        | contains configuration settings for eozid or eozi-qt
eozid.pid        | stores the process id of eozid while running
...
debug.log           | contains debug information and general logging generated by eozid or eozi-qt
