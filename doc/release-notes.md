...
Eozi Core version 0.19.1 is now available from:

  <https://eozicore.org/bin/eozi-core-0.19.1/>
...
From Eozi Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Eozi Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Eozi Core does not yet change appearance when
...
- #17488 fix "eozid already running" warnings on macOS (fanquake)
...
[Transifex](https://www.transifex.com/eozi/eozi/).
