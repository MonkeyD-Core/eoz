Eozi Core version 0.13.2 is now available from:

  <https://eozi.org/bin/eozi-core-0.13.2/>
...
- #8908 `4a974b2` Update eozi-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow eozi-tx to create v2 transactions (btcdrak)
