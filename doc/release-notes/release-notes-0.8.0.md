Eozi-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/eozi/files/Eozi/eozi-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Eozi
...
New/changed settings (command-line or eozi.conf file)
--------------------------------------------------------
