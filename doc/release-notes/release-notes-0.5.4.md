Eozi version 0.5.4 is now available for download at:
http://sourceforge.net/projects/eozi/files/Eozi/eozi-0.5.4/
...
http://gitorious.org/eozi/eozid-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Eozi-Qt notifications under Growl 1.3.
Increase required age of Eozi-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxEozi properly when installing Eozi-Qt over it. (Windows)
