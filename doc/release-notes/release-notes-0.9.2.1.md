Eozi Core version 0.9.2.1 is now available from:

  https://eozi.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 EOZ to 0.01 EOZ
...
- Fix "Start eozi on system login"
