Download URL: https://sourceforge.net/projects/eozi/files/Eozi/eozi-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 EOZ fee schedule (users still pay 0.01 EOZ per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #eozi00 - #eozi99
