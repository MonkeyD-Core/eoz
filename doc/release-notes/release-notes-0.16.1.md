Eozi Core version 0.16.1 is now available from:

  <https://eozicore.org/bin/eozi-core-0.16.1/>
...
- #12843 `df38b13` Test starting eozid with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure eozid processes are cleaned up when tests end (sdaftuar)
