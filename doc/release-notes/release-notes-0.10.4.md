Eozi Core version 0.10.4 is now available from:

  <https://eozi.org/bin/eozi-core-0.10.4/>
...
- #6953 `43c2789` Split eozi-tx into its own package
- #6953 `dfe0d4d` Include eozi-tx binary on Debian/Ubuntu
